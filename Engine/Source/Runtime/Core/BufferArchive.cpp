...
namespace Drn
{
	...
	BufferArchive& BufferArchive::operator<<( Float16 Value )
	{
		*this << Value.Encoded;
		return *this;
	}
	...
	BufferArchive& BufferArchive::operator<<( const std::vector<Vector2Half>& Value )
	{
		return WriteVector(Value);
	}
	...
	BufferArchive& BufferArchive::operator<<( const Vector2Half& Value )
	{
		*this << Value.X;
		*this << Value.Y;
	...
	BufferArchive& BufferArchive::operator<<( const Color& Value )
	{
		*this << Value.DWColor();
		return *this;
	}
	...
	BufferArchive& BufferArchive::operator>>( std::vector<Vector2Half>& Value )
	{
		return ReadVector(Value);
	}
	...
	BufferArchive& BufferArchive::operator>>( std::vector<Color>& Value )
	{
		return ReadVector(Value);
	}
	...
	BufferArchive& BufferArchive::operator>>( Vector2Half& Value )
	{
		*this >> Value.X >> Value.Y;
		return *this;
	}

	BufferArchive& BufferArchive::operator>>( Color& Value )
	{
		*this >> Value.DWColor();
		return *this;
	}
