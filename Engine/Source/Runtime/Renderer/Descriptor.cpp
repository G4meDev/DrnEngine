...
namespace Drn
{
	...
	DescriptorManager::HeapOffset DescriptorManager::AllocateHeapSlot( HeapIndex& outIndex )
	{
	...
	void DescriptorManager::FreeHeapSlot( HeapOffset Offset, HeapIndex index )
	{
		ScopeLock Lock(&CritSect);
	...
	void DescriptorManager::AllocateHeap()
	{
	...
	int32 DescriptorManager::GetNumAllocatedHandles()
	{
		int32 Result = 0;
