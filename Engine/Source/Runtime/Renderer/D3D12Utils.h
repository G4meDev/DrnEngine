...
#define DISTORTION_FORMAT DXGI_FORMAT_R8G8B8A8_UNORM
#define DISTORTION_STENCIL_WRITE_MASK	(uint8)1
#define DISTORTION_STENCIL_COMP_MASK	(uint8)1
#define DISTORTION_STENCIL_REF			(uint8)1
