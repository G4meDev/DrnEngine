...
struct Resources
{
    ...
    uint DistortedSceneColorTextureIndex;
};
...
float4 Main_PS(PixelShaderInput IN) : SV_Target
{
    ...
    Texture2D DistortedSceneColorTexture = ResourceDescriptorHeap[BindlessResources.DistortedSceneColorTextureIndex];
    
    return DistortedSceneColorTexture.Sample(PointSampler, IN.UV);
}