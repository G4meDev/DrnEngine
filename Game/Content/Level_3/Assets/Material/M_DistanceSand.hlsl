...
struct ParametersBuffers
{
    ...
    SCALAR(TileBaseColor, TileBaseColor)
    SCALAR(TileNormal, TileNormal)
...
PixelShaderOutput Main_PS(PixelShaderInput IN) : SV_Target
{
    ...
    float3 BaseColor = BaseColorTexture.Sample(BaseColorSampler, UV0 * Parameters.TileBaseColor).rgb;
    BaseColor *= Parameters.BaseColorTint.rgb;
    float Roughness = 0.9f;
    
    float3 TangentNormal = ReconstructTextureNormal(NormalTexture.Sample(NormalSampler, UV0 * Parameters.TileNormal).rg, false);
