...
PixelShaderOutput Main_PS(PixelShaderInput IN) : SV_Target
{
    ...
    BaseColor *= saturate(WallAO + Parameters.AOIntensity);
    
    float Roughness = lerp(Parameters.RoughnessCleanBrickHigh, Parameters.RoughnessCleanBrickLow, Desaturation(CachedColor, DefaultLuminanceFactors, 1.0f));
