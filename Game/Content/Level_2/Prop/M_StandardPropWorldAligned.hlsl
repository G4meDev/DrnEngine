...
struct ParametersBuffers
{
    ...
    SCALAR(TriaplanerScale, TriaplanerScale)
...
PixelShaderOutput Main_PS(PixelShaderInput IN) : SV_Target
{
    ...
    float3 BaseColor = WorldAlignedTexture(WorldPosition, Parameters.TriaplanerScale, BaseColorTexture, BaseColorSampler, VertexNormal, Parameters.TransitionContrast).rgb;
    BaseColor = lerp(BaseColor, Parameters.ColorTint.xyz, Parameters.ColorTint.a);
    
    float3 Masks = WorldAlignedTexture(WorldPosition, Parameters.TriaplanerScale, MasksTexture, MasksSampler, VertexNormal, Parameters.TransitionContrast).rgb;
    Masks.g *= Parameters.RoughnessMultiplier;
    
    float3 Normal = WorldAlignedTexture(WorldPosition, Parameters.TriaplanerScale, NormalTexture, NormalSampler, VertexNormal, Parameters.TransitionContrast).rgb;
